...
#ifndef SOURCE_RENDER_VK_PIPELINE_VKVERTEXINPUTBINDING_HPP_
#define SOURCE_RENDER_VK_PIPELINE_VKVERTEXINPUTBINDING_HPP_
...
#endif /* SOURCE_RENDER_VK_PIPELINE_VKVERTEXINPUTBINDING_HPP_ */
