...
#ifndef SOURCE_CORE_GHI_RENDERMATH_RENDERMATRIX_HPP_
#define SOURCE_CORE_GHI_RENDERMATH_RENDERMATRIX_HPP_
...
#endif /* SOURCE_CORE_GHI_RENDERMATH_RENDERMATRIX_HPP_ */
