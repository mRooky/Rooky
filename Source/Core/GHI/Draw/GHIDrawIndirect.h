...
#ifndef SOURCE_CORE_GHI_RENDERDRAW_RENDERDRAWINDIRECT_H_
#define SOURCE_CORE_GHI_RENDERDRAW_RENDERDRAWINDIRECT_H_
...
#endif /* SOURCE_CORE_GHI_RENDERDRAW_RENDERDRAWINDIRECT_H_ */
