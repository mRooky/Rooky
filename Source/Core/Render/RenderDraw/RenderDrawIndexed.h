...
#ifndef SOURCE_CORE_RENDER_RENDERDRAW_RENDERDRAWINDEXED_H_
#define SOURCE_CORE_RENDER_RENDERDRAW_RENDERDRAWINDEXED_H_
...
#endif /* SOURCE_CORE_RENDER_RENDERDRAW_RENDERDRAWINDEXED_H_ */
