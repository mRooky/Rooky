...
#ifndef SOURCE_CORE_RENDER_RENDERSTATE_RENDERRASTERIZATION_H_
#define SOURCE_CORE_RENDER_RENDERSTATE_RENDERRASTERIZATION_H_
...
#endif /* SOURCE_CORE_RENDER_RENDERSTATE_RENDERRASTERIZATION_H_ */
