...
#ifndef SOURCE_CORE_RENDER_RENDERSTATE_RENDERCOLORBLEND_H_
#define SOURCE_CORE_RENDER_RENDERSTATE_RENDERCOLORBLEND_H_
...
#endif /* SOURCE_CORE_RENDER_RENDERSTATE_RENDERCOLORBLEND_H_ */
