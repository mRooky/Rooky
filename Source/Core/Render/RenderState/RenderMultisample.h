...
#ifndef SOURCE_CORE_RENDER_RENDERSTATE_RENDERMULTISAMPLE_H_
#define SOURCE_CORE_RENDER_RENDERSTATE_RENDERMULTISAMPLE_H_
...
#endif /* SOURCE_CORE_RENDER_RENDERSTATE_RENDERMULTISAMPLE_H_ */
