...
#ifndef SOURCE_CORE_RENDER_PIPELINESTATE_RENDERINPUTASSEMBLY_H_
#define SOURCE_CORE_RENDER_PIPELINESTATE_RENDERINPUTASSEMBLY_H_
...
#endif /* SOURCE_CORE_RENDER_PIPELINESTATE_RENDERINPUTASSEMBLY_H_ */
