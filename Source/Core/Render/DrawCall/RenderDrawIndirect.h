...
#ifndef SOURCE_CORE_RENDER_DRAWCALL_RENDERDRAWINDIRECT_H_
#define SOURCE_CORE_RENDER_DRAWCALL_RENDERDRAWINDIRECT_H_
...
#endif /* SOURCE_CORE_RENDER_DRAWCALL_RENDERDRAWINDIRECT_H_ */
